...
app.get("/addHoldings", async (req, res) => {
  try {
    ...
    const ops = tempHoldings.map((item) => {
      const h = new HoldingsModel({
        name: item.name,
        qty: item.qty,
        avg: item.avg,
        price: item.price,
    ...
    console.error("/addHoldings error:", err);
...
app.get("/addPositions", async (req, res) => {
  try {
    ...
    const ops = tempPositions.map((item) => {
      const p = new PositionsModel({
    ...
    console.error("/addPositions error:", err);
